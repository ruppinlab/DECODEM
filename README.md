...
2. <b>Machine Learning</b> [see [relevant codes](./analysis/machine_learning/)]: we use a four-stage **ML pipeline** to build cell-type-specific predictors of chemotherapy response using the deconvolved expression profiles.    
