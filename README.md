...
- `get_abundance_response_corr_v2.py`: performs the association analysis of between cell type abundance and chemotherapy response, and generates Supp. Figs. 3E-G.  
