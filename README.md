...
- The scripts for [CODEFACS & LIRICS](https://github.com/ruppinlab/CODEFACS/) should be put in respectively [analysis/deconvolution/CODEFACS](analysis/deconvolution/CODEFACS/) and [analysis/deconvolution/LIRICS](analysis/deconvolution/LIRICS/).  
