...
# -*- coding: utf-8 -*-
"""
Created on Tue Apr 22 15:54:51 2025
...
if svdat:
    ...
    out_file = f"brightness_predictions_{use_samples}_th{conf_th}_{use_mdl}_{num_feat_max}features_LeaveOneOutTune_{datestamp}.pkl"
    ...
    out_file = f"brightness_results_{use_samples}_th{conf_th}_{use_mdl}_{num_feat_max}features_LeaveOneOutTune_{datestamp}.xlsx"
