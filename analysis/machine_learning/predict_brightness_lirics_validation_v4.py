...
print(f"""
dataset summary:
cohorts    = TransNEO (n = {resp_pCR_train.size:,}) [training], BrighTNess (n = {resp_pCR_test.size:,}) [validation]
...
if filter_cci:
    ...
    # use_ctps   = ["B-cells", "Myeloid", "T-cells"]                             # for SC validation - cell types present in Zhang et al. 2021
...
n_disp = 20
print(f"""
top {n_disp} most predictive CCIs for BrighTNess (n = {y_test.size:,}):
