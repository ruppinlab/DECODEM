#### -------------------------------------------------------------------------------
#### created on 07 mar 2023, 09:36am
#### author: dhrubas2
#### -------------------------------------------------------------------------------
...
## read & format data.
data.path  <- "../data/BrighTNess/out_lirics_brightness/"
data.files <- list(ramilowski = "lirics_BRCA_brightness_2015-list.rds", 
                   wang = "lirics_BRCA_brightness_kun-list.rds")
...
if (svdat){
    out.path <- data.path
    out.file <- "lirics_BRCA_brightness_SS_28Feb2023.xlsx"
